#ifndef GNOME_SETTINGS_TOOL_MACOS_H
#define GNOME_SETTINGS_TOOL_MACOS_H

#include <Tools/gnome_settings_tool.h>

class GnomeSettingsToolMacOS : public GnomeSettingsTool
{
public:
...
#endif // GNOME_SETTINGS_TOOL_MACOS_H
