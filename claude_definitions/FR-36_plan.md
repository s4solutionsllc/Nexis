...
- [ ] **7.1.1 — Restructure tests/CMakeLists.txt for per-file executables**
...
- [ ] **7.1.2 — Add PROJECT_SOURCE_DIR compile definition for theme tests**
...
- [ ] **7.3.1 — Expose parseSmartctlJson as a public static method**
...
- [ ] **7.3.2 — Make deriveHealthVerdict() public**
...
- [ ] **7.3.3 — Create DiskHealthInfo verdict tests**
...
- [ ] **7.3.4 — Create DiskHealthInfo JSON parsing tests**
...
- [ ] **7.4.1 — Add `now` parameter to getNextRunTime()**
...
- [ ] **7.4.2 — Create ScheduleManager tests**
...
- [ ] **7.5.1 — Create theme token tests**
...
- [ ] **7.6.1 — Create CommandUtil tests**
...
- [ ] **7.7.1 — Create CleanerService tests**
...
- [ ] **7.8.1 — Full clean build and test run**
